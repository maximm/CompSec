class BelllapadulaController < ApplicationController
  def index
    ...
    eve = BpSubject.new("Eve", ["A", "B"], Securitylevel.new(0), Securitylevel.new(0))
    ...
    file_b = BpObject.new("file_b", ["B"], Securitylevel.new(0))
    ...
    @curracc.addAccess(Access.new(eve, file_b, "a"))
