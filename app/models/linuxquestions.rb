class Linuxquestions
  ...
  def initialize(user, params)
    ...
    @parts = Array.new
    student1 = namer.getRandomUserNameWithGroup("Students") #Alice
    student2 = namer.getRandomUserNameWithGroup("Students") #Mindy
    teacher1 = namer.getRandomUserNameWithGroup("Teachers") #Bobby
    teacher2 = namer.getRandomUserNameWithGroup("Teachers") #Sarah
    parent1 = namer.getRandomUserNameWithGroup("Parents") #John
