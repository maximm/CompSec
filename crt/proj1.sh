...
#Create CA.crt
openssl req -new -x509 -key CA_key.pem -out CA.crt -subj /CN="Robert&Maxim"/OU="datasek"/O="LTH"/L="lund"/ST="skane"/C="se"/
#Create a scr
...
openssl x509 -req -CA CA.crt -CAkey CA_key.pem -in gaga.csr -out gaga.crt 
